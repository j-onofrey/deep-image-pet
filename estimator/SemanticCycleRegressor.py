...
import SemanticCycleEstimator as parent
import data.data_patch_util as patcher

class SemanticCycleRegressor(parent.SemanticCycleEstimator):
    ...
    def __init__(self):
        super().__init__()
        self.input_params['name'] = 'SemanticCycleRegressor'
        self.task = 'regression'
        return None


    def get_description(self):
        return "Semantic cycle consistent adversarial regressor driver class"
    ...
    def model_fn(self, features, labels, mode, params):
        return super().get_model(features, labels, mode, params)
...
if __name__ == "__main__":
    SemanticCycleRegressor().execute()
