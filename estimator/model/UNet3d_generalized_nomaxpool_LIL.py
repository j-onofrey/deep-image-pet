...
class UNet3d_generalized_nomaxpool_LIL(base_model.UNet3d):
    ...
    def __init__(self):
        ...
        self.model_params.update(UNet3d_generalized_nomaxpool_LIL.default_model_params)
        self.param_description.update(UNet3d_generalized_nomaxpool_LIL.default_param_description)
    ...
    def add_command_line_parameters(self, parser, training):
        ...
        return bis_util.add_module_args(model_group, UNet3d_generalized_nomaxpool_LIL.default_model_params,
                                        UNet3d_generalized_nomaxpool_LIL.default_param_description)

    def set_parameters(self, args, training=False, saved_params=[]):
        super().set_parameters(args, training)
        bis_util.set_multiple_parameters(self.model_params, UNet3d_generalized_nomaxpool_LIL.default_model_params, args,
    ...
    def get_loss_function(self, output_layer, labels):
        ...
        if True:
            ...
            for rot_ind in range(0,4):
                rot_angle = math.radians(rot_ind*45.0)
...
def New():
    return UNet3d_generalized_nomaxpool_LIL()
