...
class UNet3d_generalized_nomaxpool(base_model.UNet3d):
    ...
    def __init__(self):
        super().__init__()
        self.model_name = 'U-Net 3D (generalized no Pooling)'
        self.dim = 3

        self.model_params.update(UNet3d_generalized_nomaxpool.default_model_params)
        self.param_description.update(UNet3d_generalized_nomaxpool.default_param_description)
    ...
    def add_command_line_parameters(self, parser, training):
        ...
        return bis_util.add_module_args(model_group, UNet3d_generalized_nomaxpool.default_model_params,
                                        UNet3d_generalized_nomaxpool.default_param_description)

    def set_parameters(self, args, training=False, saved_params=[]):
        super().set_parameters(args, training)
        bis_util.set_multiple_parameters(self.model_params, UNet3d_generalized_nomaxpool.default_model_params, args,
...
def New():
    return UNet3d_generalized_nomaxpool()
